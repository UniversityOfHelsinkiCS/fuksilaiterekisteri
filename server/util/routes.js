...
const reclaimCaseController = require('@controllers/reclaimCaseController')
...
const { checkReclaimCase } = require('@middleware/reclaimCaseMiddleware')
...
if (!inProduction) {
  ...
  router.get('/test/reset/reclaimCase', testController.resetReclaimCases)
...
router.get('/reclaim_case', checkReclaimer, reclaimCaseController.getReclaimCases)
router.use('/reclaim_case/:reclaimCaseId', checkReclaimCase)
router.post('/reclaim_case/:reclaimCaseId/status', checkReclaimer, reclaimCaseController.updateCaseStatus)
router.post('/email/reclaimer/send', checkReclaimer, reclaimCaseController.contactCaseStudents)
