...
import { createOrUpdateAdminTemplateAction, deleteTemplateAction } from 'Utilities/redux/emailReducer'
    ...
    <div>
      ...
      <Form>
        ...
        <Button
          ...
          disabled={pending}
          onClick={() => dispatch(createOrUpdateAdminTemplateAction(emailState))}
        >
