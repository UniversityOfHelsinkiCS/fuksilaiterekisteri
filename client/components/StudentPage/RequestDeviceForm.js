...
const RequestDeviceForm = () => {
  ...
  return (
    <div>
      <h1 style={{ color: 'red' }}>
PALVELU EI OLE VIELÄ KÄYTÖSSÄ, EIVÄTKÄ ILMOITTAUTUMISET OLE PYSYVIÄ. TULE SIVULLE UUDESTAAN MA 26.8 KLO 12.00 JÄLKEEN.
        <br />
        <br />
        {' '}
SERVICE IS NOT IN USE. PLEASE RETURN ON MON 26th AFTER NOON.
      </h1>
      <Segment>
        <p>{`Hei ${user.name},`}</p>
